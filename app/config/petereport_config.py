...
PETEREPORT_TEMPLATES = {
    ...
    'report_language': "en",
    'report_title_background': "title.png", # Location: app/preport/templates/tpl/pdf/default
    'report_pages_background': "pages.png", # Location: app/preport/templates/tpl/pdf/default
    'initial_text': 'TBC',
