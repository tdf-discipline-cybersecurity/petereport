...
export default defineComponent({
  ...
  async created() {
    ...
    const div_attackflow_afb_fetch_link = document.querySelector('#petereport_attackflow_afb_fetch_link') as HTMLElement;
    let attackflow_afb_fetch_link: string  = div_attackflow_afb_fetch_link.getAttribute('value') as string;
    if(attackflow_afb_fetch_link) {
      src = attackflow_afb_fetch_link;
    }
    if(src) {
      try {
