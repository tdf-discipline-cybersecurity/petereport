    ...
    getters: {
        ...
        fileMenu(_s, getters, rootState): ContextMenu {
            ...
            let sections: ContextMenuSection[] = [
                ...
                getters.savePetereportFileMenu,
            ].filter(Boolean);
            // Menu
         ...
         *  The 'save file' menu section.
         */
        savePetereportFileMenu(_s, _g, rootState, rootGetters): ContextMenuSection {
            let ctx = rootState.ApplicationStore;
            //let file = ctx.settings.hotkeys.file;
            let page = ctx.activePage.page;
            return {
                ...
                items: [
                    {
                        text: "Save Attack Flow to Petereport and Exit",
                        type: MenuType.Item,
                        data: () => new App.SaveToPetereport(ctx)
                    },
                ]
            }
        },
